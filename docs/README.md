...
This is the `docs/` folder, so GitHub Pages can serve it directly:

1. Push the repository to GitHub (this folder on the branch you publish from, normally `main`).
...
5. The site appears at `https://<owner>.github.io/<repo>/` within a minute or two.
